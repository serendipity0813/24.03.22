...
public class CharacterStatsHandler : MonoBehaviour
{
    ...
    private void ApplyRangedStats(Func<float, float, float> operation, CharacterStats newModifier)
    {
        ...
        currentRangedAttacks.multipleBulletAngle =
            operation(currentRangedAttacks.multipleBulletAngle, rangedAttacksModifier.multipleBulletAngle);
        ...
        currentRangedAttacks.numberOfBulletPerShot = Mathf.CeilToInt(operation(currentRangedAttacks.numberOfBulletPerShot,
            rangedAttacksModifier.numberOfBulletPerShot));
